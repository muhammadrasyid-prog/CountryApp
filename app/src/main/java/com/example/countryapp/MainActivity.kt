...
import com.example.countryapp.databinding.ActivityMainBinding   // ganti sesuai package lo
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        with(binding){
            ...
            btnShowAlertDialog.setOnClickListener {
                ...
                alertBuilder.setMessage("Apakah Anda yakin ingin keluar dari aplikasi?")
                alertBuilder.setPositiveButton("Ya") { dialog, which ->
                    finish()
                }
